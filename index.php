...
<p>Sastojala bi se od 3 dijela: Popis korisnika, Popis lokacija te Evidencija stanja.</p>
...
<p>Koristit će se sljedeće tehnologije: Bootstrap framework (HTML, CSS, JS) kao frontend te PHP kao backend za komunikaciju sa MySQL bazom podataka.</p>
</div>
</div>
<?php 
